...
- Invite is a **file**, not a URL: `<slug>.travel.invite` (JSON:
  ...
  opens it from «Unirse con una invitación» in the launch dashboard
  (splash mosaic — also the only place to switch/create/delete travels;
  the header title button navigates back to it). Single
